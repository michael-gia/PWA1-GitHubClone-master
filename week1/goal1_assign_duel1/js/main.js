...
(function(){
    ...
    function fight(){
        alert(fighter1[0]+":"+fighter1[2]+"  *START*  "+fighter2[0]+":"+fighter2[2]); //This is the initial alert informing the user of the opponents health as well as their own health.
        for (var i = 0; i < 10; i++) //The i represents the peramiters of this particular function, in the case the fight function. This is the basic loop code allowing the loop to proceed in a logical order and defines a stopping point in order to prevent an infinite loop.
        {
            ...
            console.log(fighter1[0]+": "+fighter1[2] + " " + fighter2[0]+":"+fighter2[2]); //This console log outputs the result of the first round. THis will tell the user each player's health.
